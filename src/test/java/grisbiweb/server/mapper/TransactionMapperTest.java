...
public class TransactionMapperTest {
	...
	public void should_transaction_xml_to_transaction_work() {
		...
		softly.assertThat(transaction.getDate()).as("getDate")
				.isEqualTo(DateUtils.parseEnglishLocalDate(transactionXml.getDt()));
	...
	@Test
	public void should_transaction_creation_dto_to_transaction_work() {
		TransactionCreationDto transactionCreationDto = TestHelper.manufacture(TransactionCreationDto.class);

		Transaction transaction = MAPPER.transactionCreationDtoToTransaction(transactionCreationDto);
		
		assertThat(transaction.getAccountId()).isEqualTo(transactionCreationDto.getAccountId());
		assertThat(transaction.getAmount()).isEqualTo(transactionCreationDto.getAmount());
		assertThat(transaction.getCategoryId()).isEqualTo(transactionCreationDto.getCategoryId());
		assertThat(transaction.getDate()).isEqualTo(transactionCreationDto.getDate());
		assertThat(transaction.getPartyId()).isEqualTo(transactionCreationDto.getPartyId());
		assertThat(transaction.getSubCategoryId()).isEqualTo(transactionCreationDto.getSubCategoryId());
	}
}
