 ...
 *       &lt;attribute name="Nbc" use="required" type="{http://www.w3.org/2001/XMLSchema}NMTOKEN" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class SubCategoryXml {
    ...
    protected String nb;
    @XmlAttribute(name = "Nbc", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NMTOKEN")
    protected String nbc;
    ...
    /**
     * Gets the value of the nbc property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the nbc property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setNbc(String value) {
        this.nbc = value;
    }
